...
defined('APP_BASE') || define('APP_BASE', dirname(dirname(__FILE__)));
defined('APPLICATION_PATH') || define('APPLICATION_PATH', APP_BASE.'/application');
require_once APP_BASE.'/library/vendor/autoload.php';
 ...
 * as this file.
 */
	$system_path = APP_BASE.'/library/system';
